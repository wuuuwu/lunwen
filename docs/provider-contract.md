...
The current adapters use the OpenAI-compatible Chat Completions shape because it is supported by
both configured providers. The harness still performs local JSON Schema and Pydantic validation;
